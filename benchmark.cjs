...
function privateKeyToBytes(privateKey) {
    return bee_js_1.Utils.hexToBytes(removeZeroFromHex(privateKey));
}
/**
...
function mnemonicToSeed(mnemonic) {
    return bee_js_1.Utils.hexToBytes(removeZeroFromHex(ethers_1.utils.mnemonicToSeed(mnemonic)));
}
/**
